package net.mcreator.projectnumfive;
...
@Mod("project_numfive")
public class ProjectNumfiveMod {
	public static final Logger LOGGER = LogManager.getLogger(ProjectNumfiveMod.class);
	public static final String MODID = "project_numfive";

	public ProjectNumfiveMod(IEventBus modEventBus) {
